        ...
        /***/ function (module, exports, __webpack_require__) {
            /* WEBPACK VAR INJECTION */ (function (global) {
                ...
                Card = (function () {
                    ...
                    Card.prototype.initializedDataAttr =
                    ...
                    function Card(opts) {
                        ...
                        toInitialize = QJ.isDOMElement(this.$container)
                            ...
                            : this.$container[0];
                        if (
                            toInitialize.getAttribute(this.initializedDataAttr)
                        ) {
                            return;
                        }
                        toInitialize.setAttribute(
                        ...
                        QJ.on(el, "keyup change paste", function (e) {
                            ...
                            for (
                                ...
                                if (opts.fill) {
                                    outVal =
                                        val +
                                        outDefaults[i].substring(val.length);
                                } else {
	...
	*/
                    ...
                    if (el.length) {
                        return (function () {
                            ...
                            for (i = 0, len = el.length; i < len; i++) {
                                e = el[i];
                                results.push(
                                    QJ.toggleClass(e, className, bool)
                                );
                            }
                            return results;
                        })();
                ...
                (function () {
                    ...
                    formatCardNumber = function (maxLength) {
                        return function (e) {
                            ...
                            if (maxLength) {
                                upperLengths = upperLengths.filter(function (
                                    x
                                ) {
                                    return x <= maxLength;
                                });
                    ...
                    Payment = (function () {
                        ...
                        Payment.fns = {
                            ...
                            validateCardNumber: function (num) {
                                ...
                                return (
                                    ((ref = num.length),
                                    indexOf.call(card.length, ref) >= 0) &&
                            ...
                            formatCardNumber: function (num) {
                                ...
                                upperLength =
                                    card.length[card.length.length - 1];
                                num = num.replace(/\D/g, "");
                                num = num.slice(0, upperLength);
                                if (card.format.global) {
                                    return (ref = num.match(card.format)) !=
                                        null
                                        ? ref.join(" ")
                                        : void 0;
                                } else {
                        ...
                        Payment.formatCardExpiryMultiple = function (
                            month,
                            year
                        ) {
        ...
        /***/ function (module, exports) {
            ...
            is.base64 = function (value) {
                return (
                    is.string(value) &&
                    (!value.length || base64Regex.test(value))
                );
            };
