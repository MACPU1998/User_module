          ...
          <li class="nav-item navbar-dropdown dropdown-user dropdown">
            <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
              <div class="avatar avatar-online">
                @php
                    $image = auth("admin")->user()->image ? asset('storage/images/avatars/'.auth("admin")->user()->id.'/'.auth("admin")->user()->image) : asset('assets/img/default/avatar.jpg');
                @endphp
              ...
              <li>
                <a class="dropdown-item" href="javascript:void(0);">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1">
                      <span class="fw-semibold d-block">{{auth("admin")->user()->first_name." ".auth("admin")->user()->last_name}}</span>
