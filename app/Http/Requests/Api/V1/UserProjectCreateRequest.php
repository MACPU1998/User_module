...
class UserProjectCreateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'picture1' => 'required|file|mimes:jpg,jpeg,png|max:10240',
            'picture2' => 'required|file|mimes:jpg,jpeg,png|max:10240',
            'picture3' => 'required|file|mimes:jpg,jpeg,png|max:10240',
            'picture4' => 'nullable|file|mimes:jpg,jpeg,png|max:10240',
            'picture5' => 'nullable|file|mimes:jpg,jpeg,png|max:10240',
            'sale_partner_name' => 'nullable|string|max:64',
