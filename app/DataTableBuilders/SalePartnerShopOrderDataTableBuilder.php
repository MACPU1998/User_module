...
class SalePartnerShopOrderDataTableBuilder extends AbstractDataTableBuilder
{
    ...
    public function columns()
    {
        ...
        $this->DataTableBuilder->setColumn("user_id",__("general.sale_partner"),function ($value,$model){
        ...
        $this->DataTableBuilder->setColumn("actions","",function($value,$model)
        {
            $data['buttons'][]=[
                "type"=>"link",
                "title"=>"ویرایش",
                "route"=>route('admin.sale_partners_management.giftshop_orders.edit',$model->id),
                "attributes"=>[],
                "permission"=>"admin.sale_partners_management.giftshop_orders.edit",
            ];
//            $data['buttons'][]=[
//                "type"=>"delete",
//                "title"=>"حذف",
...
//            ];
    ...
    public function filterColumn()
    {
        ...
        $this->DataTableBuilder->setFilterColumn("user_id","filter_sale_partner","select","=","col-md-3",$users);
